...
Isolation criteria includes no halos more masive than each member in
the pair closer than $1.3$\mpc, and with no massive neighbors within $5$\mpc.
...
our LGs. 
We find that the LGs in the GS are located across all different
...
We now characterize the preferred place of the LG samples in terms of the
...
the average ellipciticy and prolateness does not differ significantly
...
Consistent with our results of no strong alignement.
...
$1-4\times 12^{12}$\Msun implies that the preferred environment are
