...
\begin{figure}
\begin{center}
  \includegraphics[width=0.48\textwidth]{alignments_e1_nall_environments.pdf} 
  \includegraphics[width=0.48\textwidth]{alignments_e2_nall_environments.pdf} 
  \includegraphics[width=0.48\textwidth]{alignments_e3_nall_environments.pdf} 
\end{center}
...
\begin{figure}
\begin{center}
  \includegraphics[width=0.48\textwidth]{alignments_e1_rall_environments.pdf} 
  \includegraphics[width=0.48\textwidth]{alignments_e2_rall_environments.pdf} 
  \includegraphics[width=0.48\textwidth]{alignments_e3_rall_environments.pdf} 
\end{center}
...
%%   mass. The flip in the alignment in the vector connecting the two
%%   dominant halos in pairs is a summary of the results in Figure
%%   \ref{fig:alignment}. 
%% \label{fig:scheme}}
%% \end{center}
%% \end{figure}
...
%\begin{figure*}
%\begin{center}
%  \includegraphics[width=0.49\textwidth]{ELL_histogram_filament.pdf}
%  \includegraphics[width=0.49\textwidth]{PROL_histogram_filament.pdf}
%  \includegraphics[width=0.49\textwidth]{ELL_histogram_sheet.pdf}
%  \includegraphics[width=0.49\textwidth]{PROL_histogram_sheet.pdf}
%\end{center}
